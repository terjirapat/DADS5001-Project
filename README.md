...
Dataset : 
- ข้อมูลอสังหาแต่ละโครงการในประเทศไทยโดยแสดง ที่ตั้ง ราคา พื้นที่และค่าเช่า เป็นต้น โดยเก็บรวบรวมข้อมูลจาก baania ซึ่งเป็นเว็ปไซต์ประกาศขายและเช่าอสังหาริมทรัพย์
...
- ความยากในการ Clean ข้อมูลเนื่องจากข้อมูลที่เก็บมายังไม่ผ่านการ Clean จึงมี Duplicate และ Null จำนวนมาก
- เนื่องจากใช้ raw data หลาย file จึงต้องนำมา join เป็นไฟล์เดียวเพื่อ visualize จึงต้องเลือก key ในการนำมา join ให้ดีเพื่อไม่ให้เกิดข้อมูลหลัง join ที่ผิดพลาด
...
- Clean โดยตัด duplicate และค่า null ของแต่ละไฟล์และ Merge เข้าด้วยกัน
